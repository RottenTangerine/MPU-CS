...
<template>
  <div class="container text-center">
    <div class="my-2 leading-8 max-w-screen-lg text-left mx-auto">
      <h1 class="text-4xl text-gray-300 font-bold py-5">Add </h1>
        ...
        <div class="relative">
          ...
          <div class="bg-black p-8 border-amber-300 border border-2 rounded-lg">
            <div class="mb-3 grid grid-cols-2">
              ...
              <button class="col-span-1 md:ml-32 mt-8 text-black bg-white rounded-lg px-4 py-2 font-bold w-48" @click="confirm">Confirm Adding</button>
            </div>
          </div>
